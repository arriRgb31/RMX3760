...
bool TWPartitionManager::Prepare_Super_Volume(TWPartition* twrpPart) {
	...
	// Device-tree patch: do NOT force Can_Be_Backed_Up(false). RMX3760 wants
	// each logical (Is_Super) erofs partition selectable in Backup / Install
	// Image (twrp.flags backup=flashimg + partition.cpp). Keep wipe disabled.
